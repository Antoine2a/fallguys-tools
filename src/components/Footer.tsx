...
function Footer() {
    ...
    return (
        <div className="h-fit-content flex-none">
            <footer className="bg-gradient-to-b from-slate-500 to-slate-400 pt-7 pb-4">
                {/* //TODO: just display contact grid of logos, lot of refactor code to do but let's do it later, footer is not important */}

                <p className="flex justify-center text-sm">contact</p>
                <p className="flex justify-center text-xs">discord: KennyShield#1582</p>
                <p className="flex justify-center text-xs">email: kennyshield.pro@gmail.com</p>
