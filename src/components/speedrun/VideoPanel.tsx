...
// import { BilibiliVideo } from 'react-bilibili-video';
...
function VideoPanel() {
    const [url, setUrl] = useState('StrangeBlindingWitchHeyGuys-BuPDHJU-p_edInPX'); // https//clips.twitch.tv/StrangeBlindingWitchHeyGuys-BuPDHJU-p_edInPX
